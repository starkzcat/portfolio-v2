...
export default function ExpressJsLogo() {
  return (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-4 fill-black transition-transform duration-300 dark:fill-foreground md:size-8 md:group-hover:-translate-y-1.5 md:group-hover:scale-110">
