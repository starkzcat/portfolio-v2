...
export default function RecentProjects() {
  const projects = [
    {
      ...
      description: "An information system with task, attendance, and submission management for college new student orientation agenda.",
      githubLink: "",
      projectLink: "",
    },
    {
      ...
      description: "A company profile of financial government office with blog feature as source of information for local citizen.",
      githubLink: "",
      projectLink: "",
    },
  ]
  ...
  return (
    <div className="w-full flex flex-col gap-2 mt-5">
      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-4 justify-center">
